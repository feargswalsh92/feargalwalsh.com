...
class App extends Component {
  render() {
    ...
    <div id="content">
      ...
      <ul>
        <li class="building">Building <a href="https://zonderapp.com/" target="_blank">Zonder</a></li>
        <li class="studied">Studied at <a href="https://www.luc.edu/" target="_blank">Loyola</a> Masters CS </li>
        <li class="lives">Lives in <a href="https://goo.gl/maps/hWSw1iW4oT42" target="_blank">San Mateo</a>, works out of <a href="https://goo.gl/maps/6XYusnNUhK82" target="_blank">the local library</a></li>
